(function() {
  ...
  Series = (function(_super) {
    ...
    Series.zip = function() {
      ...
      i = 0;
      while (i < maxlen) {
        zipped.push((function() {
          var _j, _len1, _resultArr;
          _resultArr = [];
          for (_j = 0, _len1 = arrs.length; _j < _len1; _j++) {
            arr = arrs[_j];
            _resultArr.push(arr[i] || null);
          }
          return _resultArr;
        })());
        i++;
  ...
  (function(Series) {
    ...
    Series.format = function(template) {
      ...
      return format = function(date) {
        ...
        if ((date.getTime == null) || isNaN(date.getTime())) {
          return void 0;
        }
        string = [];
        i = -1;
  ...
  Series.Nest = (function() {
    ...
    Nest.prototype.sortKeys = function(sort) {
      var depth;
      if (sort == null) {
        return this._sortKeys;
      }
      depth = this.keys.length - 1;
      this._sortKeys[depth] = sort;
      return this;
    };

    Nest.prototype.sortValues = function(sort) {
      if (sort == null) {
        return this._sortValues;
      }
      this._sortValues = sort;
      return this;
    };

    Nest.prototype.rollup = function(rollup) {
      if (rollup == null) {
        return this._rollup;
      }
      this._rollup = rollup;
    ...
    Nest.prototype._map = function(data, depth) {
      ...
      if (this.keys.length > depth + 1) {
        ...
        if (this._rollup != null) {
          for (k in map) {
            dat = map[k];
            map[k] = this._rollup(dat);
          }
        } else if (this._sortValues != null) {
          for (k in map) {
            dat = map[k];
            map[k].sort(this._sortValues);
          }
        }
      }
      return map;
    ...
    Nest.prototype._entries = function(map, depth) {
      ...
      if (this._sortKeys[depth] != null) {
        keys.sort(this._sortKeys[depth]);
      }
      values = (function() {
        var _i, _len, _resultArr;
        _resultArr = [];
        for (_i = 0, _len = keys.length; _i < _len; _i++) {
          k = keys[_i];
          _resultArr.push({
            key: k,
            values: this._entries(map[k], depth + 1)
          });
        }
        return _resultArr;
      }).call(this);
  ...
  d3_dsv = function(delimiter, mimeType) {
    ...
    dsv.format = function(rows) {
      ...
      rows.forEach(function(row) {
        var field, _resultArr;
        _resultArr = [];
        for (field in row) {
          if (!fieldSet.has(field)) {
            _resultArr.push(fields.push(fieldSet.add(field)));
          } else {
            _resultArr.push(void 0);
          }
        }
        return _resultArr;
      });
